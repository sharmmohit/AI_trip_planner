...
function Landing() {
    ...
    const handleGenerateTrip = (preferences) => {
        const simulatedPlan = {
            ...
            travelWith: preferences.travelWith,
            details: "Here would be the detailed trip plan generated by the AI..."
        };
                    ...
                    {showPreferencesForm ? (
                        ...
                        <div className="w-full max-w-3xl bg-white/80 rounded-xl shadow-lg p-8 backdrop-blur-sm">
                            ...
                            <div className="text-left space-y-4">
                                ...
                                <p><strong>Duration:</strong> {generatedPlan.days} days</p>
                                <p><strong>Budget:</strong> {generatedPlan.budget}</p>
                                <p><strong>Traveling with:</strong> {generatedPlan.travelWith}</p>
                                <p className="mt-4">{generatedPlan.details}</p>
                            </div>
                            <button
                                onClick={handleCreateTrip}
                                className="mt-6 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full"
                            >
                                Plan Another Trip
                            </button>
                        </div>
